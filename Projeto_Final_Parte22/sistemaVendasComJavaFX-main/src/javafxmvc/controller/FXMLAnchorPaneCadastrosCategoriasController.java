...
public class FXMLAnchorPaneCadastrosCategoriasController implements Initializable {
    ...
    public void selecionarItemTableViewCategorias(Categoria categoria){
        if (categoria != null){
            ...
            textFieldCategoriaNome.setText(categoria.getNome()); // Exibe o nome da categoria
        }else{
            labelCategoriaCodigo.setText("");
            labelCategoriaDescricao.setText("");
            textFieldCategoriaNome.setText(""); // Limpa o campo de texto do nome da categoria
        }
    }
    ...
    public void handleButtonInserir() throws IOException {
        ...
        categoria.setNome(textFieldCategoriaNome.getText()); // Adiciona o nome da categoria
    ...
    public void handleButtonAlterar() throws IOException {
        ...
        if (categoria != null) {
            categoria.setNome(textFieldCategoriaNome.getText()); // Atualiza o nome da categoria
            boolean buttonConfirmarClicked = showFXMLAnchorPaneCadastrosCategoriasDialog(categoria);
            if (buttonConfirmarClicked) {
